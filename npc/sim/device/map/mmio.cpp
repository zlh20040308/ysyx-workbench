...
static void report_mmio_overlap(const char *name1, word_t l1, word_t r1,
                                const char *name2, word_t l2, word_t r2) {
  printf("[device-mmio], MMIO region %s@[0x%x, 0x%x] is overlapped with "
         "%s@[0x%x, 0x%x]\n",
